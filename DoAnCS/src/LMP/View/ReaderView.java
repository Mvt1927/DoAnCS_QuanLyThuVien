...
public class ReaderView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtTitle = new com.toedter.calendar.JDateChooser();
        ...
        txtTitle.setDateFormatString("dd/MM/yyyy");
        txtTitle.setMinSelectableDate(new java.util.Date(-62135791109000L));
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        ...
        String birth = new SimpleDateFormat("dd/MM/yyyy").format(txtTitle.getDate());
    ...
    private void tblBookMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBookMouseClicked
        ...
        if (selectrow >= 0) {
            ...
            if (tblBook.getValueAt(selectrow, 2) != null) {
                try {
                    txtTitle.setDate(new SimpleDateFormat("dd/MM/yyyy").parse(tblBook.getValueAt(selectrow, 2).toString()));
                } catch (ParseException ex) {
                    txtTitle.setDate(null);
                }
            } else {
                txtTitle.setDate(null);
            }
    ...
    private com.toedter.calendar.JDateChooser txtTitle;
